...
class KVBF_Debug_Bar {
  ...
  public function kvbf_style() {
    echo '
    <style type="text/css">
      #kvbf-debug-box{color:#8B0000;background:#FA8072;padding:1em 1em 1em 1.5em;position:fixed;bottom:0px;right:0px;font-family:monospace;font-size:13px;}
  ...
  public function display() {
    ...
    $memory_limit       = $this->convert( $this->let_to_num( WP_MEMORY_LIMIT ) );
    ?>
